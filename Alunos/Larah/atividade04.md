...
### O que devemos considerar para esse circuito operar como um LDO?
  A escolha do diodo zener, que deve proporcionar uma tensão de entrada para o mosfet superior a tensão de saída desejada. Mantendo a dissipação de energia (potência) baixa.
